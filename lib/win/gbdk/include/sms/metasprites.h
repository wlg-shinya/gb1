...
static uint8_t __move_metasprite(uint8_t id, int16_t x, int16_t y);
static uint8_t __move_metasprite_flipx(uint8_t id, int16_t x, int16_t y);
static uint8_t __move_metasprite_flipy(uint8_t id, int16_t x, int16_t y);
static uint8_t __move_metasprite_flipxy(uint8_t id, int16_t x, int16_t y);
 ...
 */
void hide_sprites_range(uint8_t from, uint8_t to) PRESERVES_REGS(iyh, iyl);
